...
const { userDataDir, recoveryPhrase, metamaskId, metamaskPassword, metamaskPath, tempusUrl } = require("../tests/config.json")
...
test.describe("POC tests", () => {
    ...
    async function loginToMetamask(browser) {
        ...
        await metamaskTab.fill('[placeholder="Enter your Secret Recovery Phrase"]', process.env.METAMASK_RECOVERY_PHRASE)
