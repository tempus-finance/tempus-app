...
export const TEMPUS_URL: string
    = process.env.CI ? 'https://tempus-app-stage.web.app/' : 'https://tempus-app-stage.web.app/';
export const LOAD_TIMEOUT: number = 600;
export const LOAD_SHORT_TIMEOUT: number = 200;
export const LOAD_LONG_TIMEOUT: number = 1800;
export const BROWSER_WIDTH: number = 1000;
export const BROWSER_HEIGHT: number = 500;
