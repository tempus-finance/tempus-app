  ...
  <div className="tw__tokenomics__token-distribution">
    <div className="tw__container tw__tokenomics__token-distribution-container">
      ...
      <p className="tw__tokenomics__token-distribution-description">
        The pie chart below sets out the initial three year allocation of the 1 billion TEMP total supply. At Tempus, we
        are strong believers in decentralization and so we have allocated 52% of our initial token supply to benefit
        Tempus DAO.
      </p>
      ...
      <div className="tw__tokenomics__token-distribution-chart">
        <div className="tw__tokenomics__token-distribution-chart-wrapper">
          ...
          <ChartLabel x={100} y={330} width={270} orientation="left" label="Investors &amp; Advisors" value="22.00%" />
          <ChartLabel
            x={0}
            y={100}
            width={370}
