...
export interface WalletErrorModalProps extends ModalProps {
  error: Error;
  primaryButtonLabel: ActionButtonLabels;
  onPrimaryButtonClick: () => void;
}

const WalletErrorModal: FC<WalletErrorModalProps> = props => {
  ...
  return (
    <Modal open={open} onClose={onClose}>
      <div className="tc__error-modal__content">
        ...
        <Typography variant="body-primary">{t('WalletErrorModal.errorModalDescription')}</Typography>
...
export default memo(WalletErrorModal);
