...
const defaultProps: DropdownSelectorProps = {
  label: 'Selector',
  selectedValue: 'one',
};

const subject = (props: DropdownSelectorProps) =>
  render(
...
describe('DropdownSelector', () => {
  ...
  it('opens dropdown with selections and updates selection on click', () => {
    ...
    const secondOptionButton = container.querySelector('.tc__dropdownItem__selectable:last-child > button');
