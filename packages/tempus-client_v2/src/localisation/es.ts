...
const es: { [word in Words]: string } = {
  ...
  pool: 'Pool',
  ofPool: 'del Pool',
  poolRatio: 'Ratio del Pool (Capital / Yield)',
  ...
  interestRateProtectionTooltipText:
    'Fija tu rendimiento futuro con Tempus. Esta función bloquea su token de inversión, emite Capital y Yield tokens como resultado, y cambia todos los Yield tokens por Capital a través de TempusAMM. Recibirá Capital que se canjearán 1: 1 por el activo subyacente al vencimiento.',
  liquidityProvisionTooltipText:
    'Proporcione liquidez a Tempus para obtener un rendimiento adicional. Esta función bloquea su token  de inversión, emite Capital y Yield tokens a cambio, y utiliza el número máximo disponible de Capital y Yield tokens  para proporcionar liquidez a TempusAMM.<br/><br/>Esto significa que recibirá el rendimiento subyacente y las comisiones de intercambio de Tempus, acumlados en un solo rendimiento.',
  ...
  stakedYields: 'Yield tokens invertidos',
  mintDescription: 'Divida su token de rendimiento en Capital y Yield tokens.',
  swapDescription: 'Intercambio entre Capital y Yield tokens.',
